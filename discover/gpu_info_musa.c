#ifndef __APPLE__  // TODO - maybe consider Moore Threads support on intel macs?

#include <string.h>
#include "gpu_info_musa.h"
...
void musart_init(char *musart_lib_path, musart_init_resp_t *resp) {
  ...
  if (ret != musaSuccess) {
    ...
    if (ret == CUDA_ERROR_INSUFFICIENT_DRIVER) {
      resp->err = strdup("your Moore Threads driver is too old or missing.  If you have a MUSA GPU please upgrade to run ollama");
      return;
    }
